...
// $mail->SMTPSecure='tls'; 
      ...
      if(!empty($Fullname) && !empty($Email) && !empty($Skills) && !empty($Phone)){
       if(!empty($upload_tempname)){
        if(!empty($Experience_years)){
       
      $Password = mysqli_real_escape_string($connection,$_POST['Password']);
      $Confirm_password = mysqli_real_escape_string($connection,$_POST['Confirm_password']);
      $Password="Cognate@123";
      $Confirm_password ="Cognate@123";
    ...
    <head>
        ...
        <title>JOPO-Add Applicant</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" class="my-login-validation" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="4" id="Skills" name="Skills"
                                                id="exampleFormControlTextarea4" row="0"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="position:relative" id="">
                                                ...
                                                <label list="Location_country" type="text" for="">Current CTC<span
                                                        style="color:red">*</span></label>
                                                <input list="Current_Salary_lakhs" class="form-control"
                                                    name="Current_Salary_lakhs" value="<?php echo isset($_POST['Current_Salary_lakhs']) ? $_POST["Current_Salary_lakhs"] : ''; ?>" required="" type="text">
                                                <datalist id="Current_Salary_lakhs" onclick="Current_Salary_lakhs ()">
                                                    ...
                                                    <option value="3,00,000-4,00,000"></option>
                                                    <option value="4,00,000-5,00,000"></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="position:relative" id="">
                                                <!-- <datalist id="hosting-plan"> -->
                                                <label list="Location_country" type="text" for="">Expected CTC<span
                                                        style="color:red">*</span></label>
                                                <input list="Expected_Salary_lakhs" class="form-control"
                                                    name="Expected_Salary_lakhs"
                                                    value="<?php echo isset($_POST['Expected_Salary_lakhs']) ? $_POST["Expected_Salary_lakhs"] : ''; ?>" required="" type="text">
                                                <datalist id="Expected_Salary_lakhs" onclick="Expected_Salary_lakhs ()">
                                                    <option value="Below&5000/"></option>
                                                    <option value="5000-10000"></option>
                                                    <option value="10,000-25,000"></option>
                                                    <option value="25,000-50,000"></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="position:relative" id="">
                                                <!-- <datalist id="hosting-plan"> -->
                                                <label list="Location_country" type="text" for="">Experience<span
                                                        style="color:red">*</span></label>
                                                <input list="Experience_years" class="form-control"
                                                    name="Experience_years"
                                                    value="<?php echo isset($_POST['Experience_years']) ? $_POST["Experience_years"] : ''; ?>" required="" type="text">
                                                <datalist id="Experience_years" onclick="Experience_years ()">
                                            ...
                                            <span style="color:#ff0000"><?php echo $empty_experience; ?></span>
                                        </div>
                                        &nbsp;
                                        <div class="form-group">
                                            <label for="">Note <span style="color:red">*</span> </label>
                                            <textarea class="form-control" rows="4" id="Skills" style="width: 320px;"
                                                name="Recruiters_note"
                                                require><?php echo isset($_POST["Recruiters_note"]) ? $_POST["Recruiters_note"] : ''; ?></textarea>
                                            <span style="color:#ff0000"><?php echo $message_skills; ?></span>
                                        </div>

                                        <div class="form-group">
                                            <label for="text">CV <span style="color:red">*</span></label>
                                            <div style="position:relative" id="">
                                                <input type="file" name="file" id="" class="custom-file-upload-input"
                                                    style="" data-bit-id="cvFileUpload" />
                                            </div>
                                        ...
                                        <div class="form-group m-0">
                                            <button type="submit" name="submit"
                                                ...
                                                class="btn head-btn1">+ Add Applicant
                                            </button>
                                        </div>
