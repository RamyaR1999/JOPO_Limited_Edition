...
<body>
    ...
    <section>
        ...
        <div class="container emp-profile">
                    ...
                    <a href="JOPO.zip" download class="btn head-btn1"><i class="fas fa-download"
                            style="font-size:20px;color:lightblue;text-shadow:1px 1px 2px #000000;"></i> Download JOPO</a>
                    </div>
            <form action="" autocomplete="off" method="post" enctype="multipart/form-data">
                <br>
                <embed src="Readme/<?php echo "JOPO_installation_procedure.pdf" ?>"  type="application/pdf" width="100%" height="1000px" />
                <br>
                <br>
