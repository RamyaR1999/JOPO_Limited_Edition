...
<head>
    ...
    <title>JOPO-Applicants full profile</title>
...
<body>
    ...
    <section>
        ...
        <form align="left">
            <input class="btn head-btn2 fa" style="margin-left: 60px; background: skyblue; border-radius: 72px; padding: 15px 10px;" type="button"
        ...
        <div class="container emp-profile">
            <form action="" autocomplete="off" method="post" enctype="multipart/form-data">
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Name</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;"><?php echo $Fullname ?></p>
                                    </div>
                                </div>
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Education</p>
                                    </div>
                                    <div class="col-md-6 ">
                                        <p style="color:crimson;"><?php echo $Education ?></p>
                                    </div>
                                </div>
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Email</p>
                                    </div>
                                    <div class="col-md-6 ">
                                        <p style="color:crimson;"><?php echo $Email ?></p>
                                    </div>
                                </div>
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Phone</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;"><?php echo $Phone ?></p>
                                    </div>
                                </div>
                                <!-- <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Profession</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;">Web Developer and Designer</p>
                                    </div>
                                </div> -->
                            </div>
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Experience</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;"><?php echo $Experience_years;?></p>
                                    </div>
                                </div>
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Current CTC</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;"><?php echo $Current_Salary_lakhs ?></p>
                                    </div>
                                </div>
                                <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Expected CTC</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;"><?php echo $Expected_Salary_lakhs ?></p>
                                    </div>
                                </div>
                                <!-- <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Total Projects</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;">230</p>
                                    </div>
                                </div> -->
                                <!-- <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">English Level</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;">Expert</p>
                                    </div>
                                </div> -->
                                <!-- <div class="row nav-tabs">
                                    <div class="col-md-6">
                                        <p style="color:#000000; font-weight: 700;">Availability</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p style="color:crimson;">6 months</p>
                                    </div>
                                </div> -->
                                <!-- <div class="row nav-tabs">
                                    <div class="col-md-12">
                                        <p style="color:#000000; font-weight: 700;">Your Bio</p><br />
                                        <p style="color:crimson;">Your detail description</p>
                                    </div>
                                </div> -->
                            </div>
                        </div>
                ...
                <br>
                <embed src="cv/<?php echo $CV ?>"  type="application/pdf" width="100%" height="1000px" />
                <br>
                <br>
                    <?php 
