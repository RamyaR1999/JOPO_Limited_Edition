...
<head>
    ...
    <title>JOPO-Search Applicants</title>
...
?>
                ...
                <img class="" style="width:40px; height:40px; border-radius: 100%;"
                    src='images/<?php echo $Image ?>' alt="">
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                    <img class="" style="width:60px; height:60px; border-radius: 100%;"
                        src='images/<?php echo $Image ?>' alt="">
...
<style>
    ...
    <div class="container">
        ...
        <br />
        <br /> -->
        <h2 align="left" style="color:crimson; font-family:poppins;">Search CVs
        </h2><br />
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div align="left" class="col-md-3">
                    <input type="text" name="Skills" placeholder="Skills" class="form-control" data-role="tagsinput"  value="<?php echo isset($_POST["Skills"]) ? $_POST["Skills"] : ''; ?>" />
                </div>
                <div align="left" class="col-md-3">
                    <input type="text" name="CV_date" id="tags1" placeholder="Month / Year" class="form-control" data-role="tagsinput" value="<?php echo isset($_POST["CV_date"]) ? $_POST["CV_date"] : ''; ?>" />
                </div>

                <div align="right" class="col-md-3">
                    <form action="" method="post" autocomplete="off">
                    <div class="form-group">
                        <input class="form-control" value="<?php if(empty($_POST["Experience_years"])){ echo ""; }else{ echo isset($_POST["Experience_years"]) ? $_POST["Experience_years"] : ''; } ?>" id="tags2" placeholder="Experience" name="Experience_years" list="Experience_years" type="text" autocomplete="off">
                        <div style="position:relative" id="">
                            <datalist type="text" id="Experience_years" onclick="" required="">
                ...
                <div class="col-md-2">
                    <button type="submit" style="line-height: 22px; padding: 4px 10px; border-radius: 0px;" name="query" class="btn head-btn2" id="search">Search</button>
                </div>
            </div>
        </div>
       </form> 
       ...
       <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <?php
          ...
          if (isset($_POST['query'])){
            ...
            $Skill=trim(str_replace(",", "%", $_POST['Skills']));
            $Experienced=trim($_POST['Experience_years']);
            $CV_date=str_replace(",", "|", $_POST['CV_date']);
            ...
            if($Skill != "" AND $Experienced == "" AND $CV_date == ""){
                ...
                ?>
                    <div class="table-responsive">
                        <div align="left">
                            <p><b style="color:crimson;">Total Records - <?php echo $Skill; ?></b></p>
                        </div>
                    </div>
                <?php
                ...
                if ($search_users = mysqli_query($connection, $query)) {
                    ...
                    <div class="table-responsive">
                        <div align="left">
                            <p><b style="color:crimson;">Total Records - <?php echo $rowcount; ?></b></p>
                        </div>
                    </div>
                    <?php
                }
    ...
    <div class="col-12 col-sm-8 col-md-6 col-lg-10" style="margin-left: 100px;">
        <div class="card">
            <div class="card-body text-center">
                <div class="u-align-right" style="text-align: right;">
                    <a class="u-nav-link" id="UserDropdown" href="" data-toggle="dropdown" aria-expanded="false"><i style="font-size:22px" class="fa fa-ellipsis-v"></i>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                        <!-- <a onClick=("Are you Sure you want to delete' + data[count] .Fullname + 'profile"); href="new-profile.php?delete=' + data[count] .id + '"class="dropdown-item">Delete</a> -->
                ...
                <div class="u-layout-row">
                    <div class="u-align-left" style="width: 550px;">
                        <p class="card-text"><span style="font-weight: 500; font-size: 0.86rem; color: #000000;">Name:&nbsp;&nbsp;</span><span class="card-subtitle mb-2" style="color: crimson; ">
                            <?php echo $Fullname; ?></span>
                        </p>
                        <p class="card-text"><span style="font-weight: 500; font-size: 0.86rem; color: #000000;">Email:&nbsp;&nbsp;</span><span class="card-subtitle mb-2 text-muted">
                            <?php echo $Email; ?></span>
                        </p>
                        <p class="card-text"><span style="font-weight: 500; font-size: 0.86rem; color: #000000;">Skills:&nbsp;&nbsp;</span><span class="card-subtitle mb-2 text-muted">
                            <?php echo $Skills; ?></span>
                        </p>
                        <p class="card-text"><span style="font-weight: 500; font-size: 0.86rem; color: #000000;">Experience:&nbsp;&nbsp;</span><span class="card-subtitle mb-2 text-muted">
                            <?php echo $Experience_years; ?></span>
                        </p>
                        <p class="card-text"><span style="font-weight: 500; font-size: 0.86rem; color: #000000;">Function:&nbsp;&nbsp;</span><span class="card-subtitle mb-2 text-muted">
                            <?php echo $Function; ?></span>
                        </p>
                        <p class="card-text"><span style="font-weight: 500; font-size: 0.86rem; color: #000000;">Uploaded On &nbsp;&nbsp;</span><span class="card-subtitle mb-2 text-muted">
                            <?php echo $CV_date; ?></span>
                        </p>
                    </div>
                    <div class="u-align-right">
                        <img class="avatar rounded-circle" style="width:150px; height:150px;" src="images/<?php echo $Image; ?>" alt="Bologna">
                         <br>
                        <a href="Jobseeker_full_profile.php?profile=<?php echo $id; ?>"class="btn head-btn1">View Profile</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php
    ...
    $query="SELECT * FROM users WHERE Experience_years = '$Experienced' AND User_type ='Users' ";
    $search_users=mysqli_query($connection, $query); 
...
<?php
  ...
  $user_id = mysqli_query($connection,$query);
    ...
    if ($user_id = mysqli_query($connection, $query)) {
        ...
        $rowcount = mysqli_num_rows( $user_id );
