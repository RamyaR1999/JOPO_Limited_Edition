    ...
    if(isset($_REQUEST['submit'])){
        ...
        if(!$select_users_query){
          ...
          while($row = mysqli_fetch_array($select_users_query)){
               ...
               $db_Experience_years =$row['Experience_years'];
               $db_Experience_months =$row['Experience_months'];
               $db_Current_Salary_lakhs =$row['Current_Salary_lakhs'];
               $db_Current_Salary_thousand =$row['Current_Salary_thousand'];
               $db_Expected_Salary_lakhs =$row['Expected_Salary_lakhs'];
               $db_Expected_Salary_thousand =$row['Expected_Salary_thousand'];
               $db_Company_Name =$row['Company_Name'];
               $db_GST =$row['GST'];
               $db_PAN_No =$row['PAN_No'];
               $db_Role =$row['Role'];
               $db_Post_count =$row['Post_count'];
               $db_Recruiters_note =$row['Recruiters_note'];
               $db_CV = $row['CV'];
        ...
        if($Password === $db_Password){
             ...
             $_SESSION['Experience_years'] = $db_Experience_years;
             $_SESSION['Experience_months'] = $db_Experience_months;
             $_SESSION['Current_Salary_lakhs'] = $db_Current_Salary_lakhs;
             $_SESSION['Current_Salary_thousand'] = $db_Current_Salary_thousand;
             $_SESSION['Expected_Salary_lakhs'] = $db_Expected_Salary_lakhs;
             $_SESSION['Expected_Salary_thousand'] = $db_Expected_Salary_thousand;
             $_SESSION['Company_Name'] = $db_Company_Name;
             $_SESSION['PAN_No'] = $db_PAN_No;
             $_SESSION['CV'] = $db_CV;
                                ...
                                <form method="POST" class="my-login-validation">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="position:relative" id="">
                                            ...
                                            <div
                                                style="position: absolute; right: 10px; top: 7px; padding: 2px 7px; font-size: 13px; cursor: pointer;">
