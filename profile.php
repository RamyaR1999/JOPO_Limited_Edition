            ...
            <div class="u-align-center u-container-style u-layout-cell u-size-20 u-layout-cell-3">
                <div class="u-container-layout u-container-layout-3">
                    ...
                    <p class="u-text u-text-7">
                        ...
                        <br><label class="" for="title"><?php echo $Skills ?></label><br>
                        ...
                        <br><label class="" for="title"><?php echo $Company_Name ?></label><br>

                        <span style="font-weight: 700;">GST: </span>
                        <br><label class="" for="title"><?php echo $GST ?></label><br>

                        <span style="font-weight: 700;">PAN No:</span>
                        <br><label class="" for="title"><?php echo $PAN_No;?>
                            <?php echo $Experience_months;?></label><br>
                        <?php
                            }
                        ?>
